...
// Cargar imágenes
const fondo = new Image(); fondo.src = 'assets/img/fondo_5.png';
const jugadorImg = new Image(); jugadorImg.src = 'assets/img/jugador5.png';
const monedaImg = new Image(); monedaImg.src = 'assets/img/moneda.png';
const balonImg = new Image(); balonImg.src = 'assets/img/bandera_liverpool.png';
...
const enemigoImg2 = new Image(); enemigoImg2.src = 'assets/img/enemigo2.png';
...
// Plataformas
const plataformas = [
    { x: 150,  y: canvas.height - 250, width: 120, height: 20 },     // más baja, punto de partida
    { x: 550,  y: canvas.height - 280, width: 150, height: 20 },     // salto hacia arriba, moderado
    { x: 1000,  y: canvas.height - 260, width: 120, height: 20 },     // salto descendente y rápido
    { x: 1000, y: canvas.height - 460, width: 140, height: 20 },     // salto largo y alto
    { x: 500,  y: canvas.height - 650, width: 120, height: 20 },     // regreso intermedio
    { x: 1200, y: canvas.height - 700, width: 120, height: 20 },     // punto máximo, difícil de alcanzar
];
...
$('#continuar-btn').on('click', () => {
    ...
    location.href = 'nivel6.html'; // Cambia a la ruta del siguiente nivel
